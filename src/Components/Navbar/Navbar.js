        ...
        <nav className="navbar navbar-expand-lg navbar-light for_mobile" >
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
              <Link className="nav-link" activeClass="active" spy to="Home" onClick={homedatas}>Home</Link>
              </li>
              <li class="nav-item" >
                <Link className="nav-link" activeClass="active" spy to="About">About</Link>
              </li>
              <li class="nav-item">
                <Link className="nav-link" activeClass="active" spy to="Education">Education</Link>
              </li>
              <li class="nav-item">
                <Link className="nav-link" activeClass="active" spy to="Service">Services</Link>
              </li>
              <li class="nav-item dropdown">
                <Link className="nav-link" activeClass="active" spy to="Portfolio">Portfolio</Link>
              </li>
              <li class="nav-item dropdown">
                <Link className="nav-link" activeClass="active" spy to="Skills">Skills</Link>
              </li>
              <li class="nav-item">
        ...
        <div>
          <div className='row'>
            <div className='col-sm-12 col-lg-6 col-md-6 namehead'>
              <div>
                <h1>Hey There!<br />I'm Harshita Patidar <br />React Developer</h1>
